<div class="container-bio">
  ...
  <div class="block-gestion">
  <div class="block-image">
    <img src="assets/img/various/dragonfly.jpg" alt="bio-photo">
  </div>
  ...
  <div class="block-text">
    <p>
      ...
      le domaine des forts grandissements nécessite une recherche du graphisme des plus poussée. Dans beaucoup de cas, le spectateur a du mal à identifier le sujet et le graphisme de l’image devient l’attrait premier. Les petits détails que je découvre dans mon viseur demandent une composition et un cadrage <span class="green">sans faille</span> et donc une recherche esthétique de chaque instant. Le graphisme devient <span class="green">aussi important que le sujet lui-même</span> mais sans aucune volonté de me détacher des autres styles de macrophotographie. Par contre, opter pour le <span class="green">MPE65</span> associé au focus-stacking est une manière de ne pas marcher sur les pas des autres photographes.
    </p>
  </div>
  </div>
